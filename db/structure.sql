...
--
-- Name: index_user_notifications_on_resource; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_notifications_on_resource ON public.user_notifications USING btree (resource_type, resource_id);
